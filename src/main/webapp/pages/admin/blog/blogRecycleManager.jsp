        ...
        <div class="main">
            ...
            <div class="operation-wrap">
                <div class="buttons-wrap">
                    <button id="recover" class="button blue radius-3"><span class="icon-plus"></span> 恢复文章</button>
                    <button id="delete" class="button red radius-3"><span class="icon-close2"></span> 彻底删除</button>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $("#recover").click(function () {
        ...
        $.ajax({
            url : "${pageContext.request.contextPath}/admin/blog/recoverFromRecycle.do",
            type : "POST",
            dataType : "json",
            traditional : "true",
            data : {
    ...
    function deleteInfo() {
        ...
        console.log(idArr);
        $.ajax({
            url : "${pageContext.request.contextPath}/admin/blog/delete.do",
            type : "POST",
            dataType : "json",
            traditional : "true",
            data : {
